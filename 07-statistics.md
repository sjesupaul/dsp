...
>>**Solve: P(I|T)** : probability that elvis had an identical twin, given he had a twin brother


>>
    P(I∩T) = P(I)P(T|I) = (1/300)(1/2) = 1/600

>>
    P(F∩T) = P(F)P(T|F) = (1/125)(1/4) = 1/500

>>
    => P(T) = P(I∩T)+P(F∩T) = (1/600)+(1/500)
...
>> Therefore, the probability Elvis had an identical twin brother is 5/11 or about 45%.
